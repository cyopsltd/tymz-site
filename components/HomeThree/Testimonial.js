          ...
          <Slider ref={sliderRef} {...settings}>
            <div className="single-testimoinal-box">
              ...
              <div className="feedback">
                “This app has made my banking work much easier which saves me a
                lot of time, I have become a fan of it.”
              </div>
            ...
            <div className="single-testimoinal-box">
              ...
              ></div>
              <div className="feedback">
                “By using online banking, I can easily keep track of various
                expenses, which saves me a lot of money.”
              </div>
              <div className="client-info">
                <div className="client-name">
                  <h6>Karen Lynn</h6>
            ...
            <div className="single-testimoinal-box">
              ...
              ></div>
              <div className="feedback">
                “I can now complete banking work from anywhere anytime, making
                my business work more dynamic.”
              </div>
              <div className="client-info">
                <div className="client-name">
                  <h6>Sean Jacobs</h6>
